...
sources = {
    "db1": {
        ...
        "driver_file": "rel/path/to/openedge.jar",
    },
    "db2": {
        "type": "sql",
        "user": "user",
    ...
    "google_drive_account": {
        "type": "google_drive",
        "access_token": "rel/path/to/token.pickle",
    },
    "sftp_server": {
        "type": "sftp",
        "protocol": "sftp",
...
jobs = {
    "example_simple_job": {
        "extract": {"db1": "rel/path/students.sql"},
        "load": {"smtp_server": "rel/path/report.csv"},
    },
    "example_complex_job": {
        "extract": {
            "db1": ["rel/path/grades.sql", "rel/path/students.sql"], 
            "db2": "rel/path/teachers.sql", 
            "fileshare": "remote/rel/path/export_file.csv",
            "sftp_server": "remote/rel/path/file.xlsx",
        },
        "load": {
            "sftp_server": ["rel/path/formatted_grades.csv", "rel/path/active_teachers.csv"], 
            "smtp_server": "", 
